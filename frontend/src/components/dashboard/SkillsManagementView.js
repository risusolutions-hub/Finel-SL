            ...
            <div className="p-4 space-y-3 max-h-96 overflow-y-auto">
              {loading ? (
                ...
                skills.map((skill, sidx) => (
                  <div key={skill.id || skill._id || `skill-${sidx}`} className="p-3 bg-slate-50 rounded-lg flex items-start justify-between">
            ...
            <div className="p-4 space-y-3 max-h-96 overflow-y-auto">
              {loading ? (
                ...
                certifications.map((cert, cidx) => (
                  <div 
                    key={cert.id || cert._id || `cert-${cidx}`} 
